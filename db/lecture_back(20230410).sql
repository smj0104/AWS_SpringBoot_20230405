...
INSERT INTO `course_mst` VALUES (1,1,1,'2023-04-01'),(2,2,1,'2023-04-01'),(3,3,1,'2023-04-01'),(4,4,1,'2023-04-01'),(5,1,2,'2023-04-01'),(6,2,2,'2023-04-01'),(7,3,2,'2023-04-01'),(8,5,2,'2023-04-01'),(9,7,2,'2023-04-01'),(10,3,3,'2023-04-01'),(11,4,3,'2023-04-01'),(12,5,3,'2023-04-01'),(13,6,3,'2023-04-01'),(14,7,3,'2023-04-01'),(15,8,3,'2023-04-01'),(16,1,4,'2023-04-01'),(17,5,4,'2023-04-01'),(18,6,4,'2023-04-01'),(19,7,4,'2023-04-01'),(20,8,4,'2023-04-01'),(21,11,4,'2023-04-01'),(22,5,5,'2023-04-01'),(23,7,5,'2023-04-01'),(24,8,5,'2023-04-01'),(25,10,5,'2023-04-01'),(26,9,6,'2023-04-01'),(27,10,6,'2023-04-01'),(28,11,6,'2023-04-01'),(29,4,7,'2023-04-01'),(30,5,7,'2023-04-01'),(31,6,7,'2023-04-01'),(32,1,8,'2023-04-01'),(33,5,8,'2023-04-01'),(34,8,8,'2023-04-01'),(35,9,8,'2023-04-01'),(36,10,8,'2023-04-01'),(37,11,8,'2023-04-01');
...
INSERT INTO `lecture_mst` VALUES (1,'스프링 부트 - 핵심 원리와 활용',99000,1),(2,'스프링 MVC 1편 - 백엔드 웹 개발 핵심 기술',99000,1),(3,'실전! 스프링 부트와 JPA활용1 - 웹 애플리케이션 개발',88000,1),(4,'스프링 DB 2편 - 데이터 접근 활용 기술',99000,1),(5,'스프링 DB 1편 - 데이터 접근 핵심 원리',77000,1),(6,'스프링 핵심 원리 - 고급편',121000,1),(7,'토비의 스프링 부트 - 이해와 원리',99000,2),(8,'만들고 비교하며 학습하는 리액트 (React)',55000,3),(9,'[리뉴얼]타입스크립트 올인원 : Part1. 기본문법편',36300,4),(10,'[리뉴얼] React로 NodeBird SNS 만들기',88000,4),(11,'[개정3판] Node.js 교과서 - 기본부터 프로젝트 실습까지',49500,4);
...
INSERT INTO `lecturer_mst` VALUES (1,'김영한','2023-01-10'),(2,'토비','2023-02-10'),(3,'김정환','2023-03-10'),(4,'조현영','2023-04-10');
...
INSERT INTO `student_mst` VALUES (1,'김종환','2023-04-10'),(2,'고병수','2023-04-10'),(3,'손민재','2023-04-10'),(4,'황창욱','2023-04-10'),(5,'김상현','2023-04-10'),(6,'김대협','2023-04-10'),(7,'손지호','2023-04-10'),(8,'최해혁','2023-04-10');
...
-- Dump completed on 2023-04-10 17:50:56
